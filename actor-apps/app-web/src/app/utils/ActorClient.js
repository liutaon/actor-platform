class ActorClient {
  ...
  requestSms(phone, success, failure) {
    window.messenger.requestSmsObsolete(phone, success, failure);
  }

  sendCode(code, success, failure) {
    window.messenger.sendCodeObsolete(code, success, failure);
  }

  signUp(name, success, failure) {
    window.messenger.signUpObsolete(name, success, failure);
  }
